                ...
                <div>
                    ...
                    <a href="/pelicula">
                        <button class="btn btn-primary fs-5 me-2 py-2 px-4" type="button"
                            style="background: var(--bs-pink);border-color: var(--bs-pink);">Recomiéndame una
                            película</button>
                    </a>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center d-inline-block mb-3 bs-icon"
                            style="background: var(--bs-pink);border-color: var(--bs-pink);"><svg
                        ...
                        <p class="card-text">MOVIES cuenta con una extensa base de&nbsp; datos que almacena información
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text">¿Te ha gustado una película que has visto? ¡Comparte tu opinión en MOVIES y
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text">MOVIES te permite llevar la cuenta de las películas que vas viendo y
